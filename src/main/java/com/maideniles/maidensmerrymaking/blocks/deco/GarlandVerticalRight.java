...
public class GarlandVerticalRight extends HorizontalDecoBlock{
    ...
    protected static final VoxelShape NORTH_AABB = Block.makeCuboidShape(8.0D, 0.0D, 0.0D, 16.0D, 16.0D, 06.0D);
    protected static final VoxelShape SOUTH_AABB = Block.makeCuboidShape(0.0D, 0.0D, 10.0D, 8.0D, 16.0D, 16.0D);

    public GarlandVerticalRight(Properties properties) {
        super(properties);
    }
