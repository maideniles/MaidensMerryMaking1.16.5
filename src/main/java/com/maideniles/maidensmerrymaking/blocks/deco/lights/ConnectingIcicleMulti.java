...
public class ConnectingIcicleMulti extends HorizontalDecoBlock {
    ...
    private VoxelShape getShape(BlockState state)
    {
        return SHAPES.computeIfAbsent(state, state1 ->
        {
            ...
            ConnectingIcicleMulti.Type type = state1.get(TYPE);
    ...
    private BlockState getDecorationState(BlockState state, IWorld world, BlockPos pos)
    {
        ...
        if(backState.getBlock() instanceof ConnectingIcicleMulti)
        {
            if(backState.get(DIRECTION) == direction.rotateY())
            {
                ...
                if(!(leftState.getBlock() instanceof ConnectingIcicleMulti) || leftState.get(DIRECTION) == direction.getOpposite())
                {
            ...
            if(backState.get(DIRECTION) == direction.rotateYCCW())
            {
                ...
                if(!(rightState.getBlock() instanceof ConnectingIcicleMulti) || rightState.get(DIRECTION) == direction.getOpposite())
                {
