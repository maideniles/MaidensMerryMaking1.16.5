...
public class ConnectingClassicMulti extends HorizontalDecoBlock {
    ...
    private VoxelShape getShape(BlockState state)
    {
        return SHAPES.computeIfAbsent(state, state1 ->
        {
            ...
            ConnectingClassicMulti.Type type = state1.get(TYPE);
    ...
    private BlockState getDecorationState(BlockState state, IWorld world, BlockPos pos)
    {
        ...
        if(backState.getBlock() instanceof ConnectingClassicMulti)
        {
            if(backState.get(DIRECTION) == direction.rotateY())
            {
                ...
                if(!(leftState.getBlock() instanceof ConnectingClassicMulti) || leftState.get(DIRECTION) == direction.getOpposite())
                {
            ...
            if(backState.get(DIRECTION) == direction.rotateYCCW())
            {
                ...
                if(!(rightState.getBlock() instanceof ConnectingClassicMulti) || rightState.get(DIRECTION) == direction.getOpposite())
                {
