...
public class ConnectingClassicWhite extends HorizontalDecoBlock {
    ...
    private VoxelShape getShape(BlockState state)
    {
        return SHAPES.computeIfAbsent(state, state1 ->
        {
            ...
            ConnectingClassicWhite.Type type = state1.get(TYPE);
    ...
    private BlockState getDecorationState(BlockState state, IWorld world, BlockPos pos)
    {
        ...
        if(backState.getBlock() instanceof ConnectingClassicWhite)
        {
            if(backState.get(DIRECTION) == direction.rotateY())
            {
                ...
                if(!(leftState.getBlock() instanceof ConnectingClassicWhite) || leftState.get(DIRECTION) == direction.getOpposite())
                {
            ...
            if(backState.get(DIRECTION) == direction.rotateYCCW())
            {
                ...
                if(!(rightState.getBlock() instanceof ConnectingClassicWhite) || rightState.get(DIRECTION) == direction.getOpposite())
                {
