    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit){
        ...
        if (!worldIn.isRemote()) {
            ...
            if (tree.getItem() == ModItems.ORNAMENTS.get()){
                ...
                worldIn.setBlockState(pos.down(), ModBlocks.DECORATED_LIGHTS_CHRISTMAS_TREE_BOTTOM.get().getDefaultState(),3);
                worldIn.setBlockState(pos, ModBlocks.DECORATED_LIGHTS_CHRISTMAS_TREE_MIDDLE.get().getDefaultState(),3);
                worldIn.setBlockState(pos.up(), ModBlocks.DECORATED_LIGHTS_CHRISTMAS_TREE_TOP.get().getDefaultState(),3);
        ...
        if (!worldIn.isRemote()) {
            ...
            if (tree.getItem() == ModItems.ORNAMENTS_WHITE.get()){
                ...
                System.out.println("O CHRISTMAS TREE, O CHRISTMAS TREE!");
                worldIn.setBlockState(pos.down(), ModBlocks.DECORATED_WHITE_LIGHTS_CHRISTMAS_TREE_BOTTOM.get().getDefaultState(),3);
                worldIn.setBlockState(pos, ModBlocks.DECORATED_WHITE_LIGHTS_CHRISTMAS_TREE_MIDDLE.get().getDefaultState(),3);
                worldIn.setBlockState(pos.up(), ModBlocks.DECORATED_WHITE_LIGHTS_CHRISTMAS_TREE_TOP.get().getDefaultState(),3);
