...
import com.maideniles.maidensmerrymaking.world.structure.PotOfGoldStructure;
...
public class ModStructures {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> POT_OF_GOLD =
            STRUCTURES.register("pot_of_gold", PotOfGoldStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(POT_OF_GOLD.get(),
