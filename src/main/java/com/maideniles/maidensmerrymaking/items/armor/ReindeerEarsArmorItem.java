...
public class ReindeerEarsArmorItem extends ArmorItem {
    ...
    private static final int[][] DAMAGE_REDUCTION_ARRAY = new int[][] {{3, 6, 8, 3}};


    public ReindeerEarsArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties group) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
            ...
            return MaidensMerryMaking.MOD_ID + ":textures/models/armor/reindeer_ears.png";
    ...
    public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
        ...
        return (A) new ReindeerEarsArmorModel();
