...
public class ColoredChickenEntity extends ChickenEntity {
    ...
    public ColoredChickenEntity(EntityType<? extends ChickenEntity> type, World worldIn) {
        super(type, worldIn);
    ...
    public void livingTick() {
        ...
        if (!this.world.isRemote && this.isAlive() && !this.isChild() && --this.timeUntilNextEgg <= 0) {
            ...
            if(rand.nextInt(20)== 0){
                this.entityDropItem(ModItems.PURPLE_EGG.get());
            }
            if(rand.nextInt(20)== 1){
                this.entityDropItem(ModItems.PINK_EGG.get());
            }

            if(rand.nextInt(20)== 2){
                this.entityDropItem(ModItems.BLUE_EGG.get());
            }

            if(rand.nextInt(20)== 3){
                this.entityDropItem(ModItems.YELLOW_EGG.get());
            }
    ...
    public ColoredChickenEntity createChild(ServerWorld world, AgeableEntity mate) {
        return ModEntityTypes.COLORED_CHICKEN.get().create(world);
    }
    ...
    public void readAdditional(CompoundNBT compound) {
        ...
        this.chickenJockey = compound.getBoolean("IsColoredChickenJockey");
    ...
    public void writeAdditional(CompoundNBT compound) {
        ...
        compound.putBoolean("IsColoredChickenJockey", this.chickenJockey);
