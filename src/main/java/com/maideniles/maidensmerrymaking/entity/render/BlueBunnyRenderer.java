...
public class BlueBunnyRenderer extends MobRenderer<ColoredBunnyEntity, ColoredBunnyModel<ColoredBunnyEntity>>{
    Random rand = new Random();

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MaidensMerryMaking.MOD_ID, "textures/entity/bunny/blue_bunny.png");


    public BlueBunnyRenderer(EntityRendererManager renderManagerIn) {
