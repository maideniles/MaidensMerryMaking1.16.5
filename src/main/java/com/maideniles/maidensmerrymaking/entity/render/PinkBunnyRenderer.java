...
public class PinkBunnyRenderer extends MobRenderer<ColoredBunnyEntity, ColoredBunnyModel<ColoredBunnyEntity>>{
    Random rand = new Random();

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MaidensMerryMaking.MOD_ID, "textures/entity/bunny/pink_bunny.png");


public PinkBunnyRenderer(EntityRendererManager renderManagerIn) {
