...
public class PurpleBunnyRenderer extends MobRenderer<ColoredBunnyEntity, ColoredBunnyModel<ColoredBunnyEntity>>{
    Random rand = new Random();

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MaidensMerryMaking.MOD_ID, "textures/entity/bunny/purple_bunny.png");


    public PurpleBunnyRenderer(EntityRendererManager renderManagerIn) {
