...
public class CyanBunnyRenderer extends MobRenderer<ColoredBunnyEntity, ColoredBunnyModel<ColoredBunnyEntity>>{


    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MaidensMerryMaking.MOD_ID, "textures/entity/bunny/cyan_bunny.png");


    public CyanBunnyRenderer(EntityRendererManager renderManagerIn) {
