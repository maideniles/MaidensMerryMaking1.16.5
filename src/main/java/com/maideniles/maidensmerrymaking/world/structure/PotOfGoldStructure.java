package com.maideniles.maidensmerrymaking.world.structure;
...
public class PotOfGoldStructure extends Structure<NoFeatureConfig> {
    public PotOfGoldStructure() {
    ...
    public Structure.IStartFactory<NoFeatureConfig> getStartFactory() {
        return PotOfGoldStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(MaidensMerryMaking.MOD_ID, "pot_of_gold/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Pot 'O Gold at " +
